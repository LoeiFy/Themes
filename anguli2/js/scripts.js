 ...
 */ 
    ...
    jQuery(document).ready(function() {
        ...
        jQuery("#post nav a").append("<span></span>");
    ...
    function icon_ani() {
        jQuery("#socialwp a").hover(function(){
            jQuery(this).animate({top:"12px"}, 400);
        }, function() {
    ...
    function toggle_search() {
        ...
        function searchActive() {
            jQuery("#searchform").stop().animate({width:"200px"},400);
            jQuery("#s").focus().blur(function () {
                jQuery("#searchform").stop().animate({width:"0"},400);
            });
        }
    };
    ...
    /*function show_menu() {
        jQuery("#menu-button").toggle(function() {
            jQuery("#s-menu").slideDown("fast");
            }, function() {
                jQuery("#s-menu").slideUp("fast");
        });
        jQuery(window).resize(function(){
            var $w_width = jQuery(window).width();
            if ($w_width > 900) {
                jQuery("#s-menu").addClass("showmenu");
            } else {
                jQuery("#s-menu").removeClass("showmenu");
            }
        });
    };*/
    ...
    if(!(jQuery.browser.msie && (jQuery.browser.version <= "8.0"))) {
        jQuery(".title").toggle(function() {
            more = jQuery(this).parent().find(".post_more");
            more_height = more.height();
            more.css("display","block");
            more.css("top",-more_height);
            jQuery(this).parent().find(".post_more").animate({top: "0"}, 300);
        }, function() {
            jQuery(this).parent().find(".post_more").animate({top: more_height}, 300);
        });
    }
    ...
    function pic_photo() {
        if ($w_width > 600){
            ...
            jQuery("#postimgs .postimg").attr({rel: "fancybox-button"});
            ...
            jQuery("#s_postimgs a.postimg").click(function() {
                return false;
            });
        } 
    };
    ...
    //LOGO ANIMATE
    /*function logo_play() {
        jQuery("#header h1 a").mouseleave(function() {
    ...
    function add_color() {
        ...
        color.each(function() {
            ...
            jQuery(this).addClass("color"+rand);
        });
    };
        ...
        if (post_lth < 39) {
            ...
            jQuery.ajax({
                ...
                success: function(data){
                    result = jQuery(data).find(".masonry");
                    nextHref = jQuery(data).find("#pagination a").attr("href");
                    jQuery("#container").append(result/*.fadeIn(300)*/);
                    $newElems = result/*.css({ opacity: 0 })*/;
                    $newElems.imagesLoaded(function(){
                        jQuery("#container").masonry(/*'reload'*/"appended", $newElems, true);
                    ...
                    //jQuery("#primary").animate({scrollTop:jQuery("#primary").scrollTop() + 200},900);
